"""
fetch_lit_hmble.py
Queries the GRID Central Data GraphQL API to find all HMBLE series in
LoL Italian Tournament - Winter 2026 and EMEA Masters - Winter 2026
...
Discovered IDs (via API introspection):
  Team:        HMBLE → id=56469
  Tournaments: LoL Italian Tournament - Winter 2026
               Regular Season: Regular Season → id=827826
               Playoffs: Playoffs             → id=827828
...
HMBLE_TEAM_ID = "56469"
TOURNAMENT_IDS = [
    # LoL Italian Tournament - Winter 2026
    "827826",  # Regular Season: Regular Season
    "827828",  # Playoffs: Playoffs
    # EMEA Masters - Winter 2026
...
def fetch_hmble_series() -> list[dict]:
    """Returns all HMBLE series in LIT + EMEA Masters Winter 2026 tournaments."""
    series: list[dict] = []
    after: str | None = None
    page = 0
...
# ── Main ──────────────────────────────────────────────────────────────────────
def main():
    print("=== GRID – HMBLE / LoL Italian Tournament + EMEA Masters - Winter 2026 ===\n")

    print("── Step 1: querying Central Data API ──")
    series_list = fetch_hmble_series()
