...
in Rift Legends - Winter 2026 and EMEA Masters - Winter 2026 (League of Legends),
then downloads:
...
Run:
    python fetch_riftlegends_barczaca.py
"""
...
TOURNAMENT_IDS = [
    ...
    "828732",  # Swiss: Swiss
    "828784",  # Group Stage: Group A
    "828734",  # Playoffs: Playoffs
    # EMEA Masters - Winter 2026
...
# ── Main ──────────────────────────────────────────────────────────────────────
def main():
    print("=== GRID – Barcząca Esports / Rift Legends + EMEA Masters - Winter 2026 ===\n")
