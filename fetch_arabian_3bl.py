"""
fetch_arabian_3bl.py
Queries the GRID Central Data GraphQL API to find all 3BL GALAXY ESPORTS series
in Arabian League - Winter 2026 and EMEA Masters - Winter 2026 (League of Legends),
then downloads:
...
Discovered IDs (via API introspection):
  Team:        3BL GALAXY ESPORTS → id=46233
  Tournaments: Arabian League - Winter 2026
               Groups: Group Stage        → id=827863
               Round 2: Seeding Bracket  → id=827869
               Round 2: Elimination Zone → id=827870
               Playoffs: Playoffs        → id=827872
...
BL3_TEAM_ID = "46233"
TOURNAMENT_IDS = [
    # Arabian League - Winter 2026
    "827863",  # Groups: Group Stage
    "827869",  # Round 2: Seeding Bracket
    "827870",  # Round 2: Elimination Zone
    "827872",  # Playoffs: Playoffs
    # EMEA Masters - Winter 2026
...
def fetch_3bl_arabian_series() -> list[dict]:
    """Returns all 3BL GALAXY ESPORTS series in Arabian League - Winter 2026 tournaments."""
    series: list[dict] = []
    after: str | None = None
    page = 0
...
# ── Main ──────────────────────────────────────────────────────────────────────
def main():
    print("=== GRID – 3BL GALAXY ESPORTS / Arabian League + EMEA Masters - Winter 2026 ===\n")

    print("── Step 1: querying Central Data API ──")
    series_list = fetch_3bl_arabian_series()
